...
#define STRING_CONFIG_H_AUTHOR "(Oscar M, PORTU Prusa BEAR - evoz3D)" // Who made the changes.
...
#define CUSTOM_STATUS_SCREEN_IMAGE //40x21
...
#define CUSTOM_MACHINE_NAME "PORTU Prusa"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 263.94
  #define DEFAULT_bedKi 47.21
  #define DEFAULT_bedKd 983.71
 ...
 */
#define FIX_MOUNTED_PROBE // evoz3D PINDA2 sin termistor
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 19, 3, -0.5 } // BEAR Extruder
...
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2.5)
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (15*60) }
