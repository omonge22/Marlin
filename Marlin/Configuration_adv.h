 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //+++++ default -1, se esta utilizando para poner el ventilador de difusor controlado +++++
//#define E0_AUTO_FAN_PIN -1 ++++ default setup ++++
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  10, 190 }, { 100,  10 }, { 190, 190 } } Se coloca una llave por cada motor
  //ejem 2motores {1/4x,1/2y}, {2/3x,1/2y}
  //ejem 3motores {1/4x,1/4y},{2/3x,2/3y},{1/2x,2/3y}
  #define Z_STEPPER_ALIGN_XY { {52.5, 105}, {157.5, 105} }
 ...
 */
#if HAS_TRINAMIC_CONFIG // ++++ PRUSA BEAR ANET A8 MOTORS
   ...
   * CHOPPER_DEFAULT_24V
   * CHOPPER_DEFAULT_36V
   * COPPER_09STEP_24V   // 0.9 degree steppers (24V)H
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only +++++ PRUSA BEAR ++++
