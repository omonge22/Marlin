...
#define STRING_CONFIG_H_AUTHOR "(Oscar M, PRUSA BEAR)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  26.95,  26.95 }
    #define DEFAULT_Ki_LIST {   1.87,   1.87 }
    #define DEFAULT_Kd_LIST {  96.75,  96.75 }
  #else
    #define DEFAULT_Kp  26.95
    #define DEFAULT_Ki   1.87
    #define DEFAULT_Kd  96.75
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 151.11
  #define DEFAULT_bedKi 23.47
  #define DEFAULT_bedKd 648.58
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 396.2, 420 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34.75, 10.05, 0 }
...
#define LCD_FEEDBACK_FREQUENCY_HZ 750
...
//
//#define REPRAP_COUNT_FULL_GRAPHIC_SMART_CONTROLLER
