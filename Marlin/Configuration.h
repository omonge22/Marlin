...
#define STRING_CONFIG_H_AUTHOR "(Oscar M, aRtiLLeRY GENIUS)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Genius
  #define DEFAULT_bedKp 91.83
  #define DEFAULT_bedKi 15.57
  #define DEFAULT_bedKd 135.42
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // +++++ disabled due to usage of probe on Z max endstop +++++

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // ++++++ enabled due to usage of probe on Z max endstop +++++
